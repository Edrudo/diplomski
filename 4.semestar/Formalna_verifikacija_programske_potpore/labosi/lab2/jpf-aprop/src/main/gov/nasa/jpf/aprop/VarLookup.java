...
public abstract class VarLookup {
  ...
  public static class PreCond extends VarLookup {
    ...
    ThreadInfo ti;
    JVMInvokeInstruction call;
        
    public PreCond (ThreadInfo ti, JVMInvokeInstruction call) {
      this.ti = ti;
      this.call = call;
    }
  ...
  public static class PostCond extends VarLookup {
    ...
    ThreadInfo ti;
    JVMReturnInstruction ret;

    public PostCond (ThreadInfo ti, JVMReturnInstruction ret, VarLookup old) {
      super(old.cache);
