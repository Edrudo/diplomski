...
public class SequenceAnalyzer extends ListenerAdapter {
  ...
  static class SequenceInfo implements Cloneable {
    ...
    void resolveReferences (JVMInvokeInstruction call, ThreadInfo ti) {
      if (localVars != null) {
    ...
    SequenceInfo (String id, String[] objSpecs, JVMInvokeInstruction call, ThreadInfo ti){
      this.id = id;
    ...
    void init (String[] objSpecs, JVMInvokeInstruction call, ThreadInfo ti) {
      isActive = true;
    ...
    SequenceInfo activate (String[] objSpecs, JVMInvokeInstruction call, ThreadInfo ti) {
      SequenceInfo si = (SequenceInfo)clone();
      init(objSpecs, call, ti);
      return si;
    }
  ...
  public void instructionExecuted (VM vm, ThreadInfo ti, Instruction nextInsn, Instruction insn) {
    ...
    if (insn instanceof JVMInvokeInstruction) {
      processInvokeInstruction(ti, (JVMInvokeInstruction)insn);
      ...
      processReturnInstruction(ti, (JVMReturnInstruction)insn);
    }
  }

  void processInvokeInstruction (ThreadInfo ti, JVMInvokeInstruction insn) {
  ...
  void updateSequenceScope (AnnotationInfo ai, ThreadInfo ti, MethodInfo mi, JVMInvokeInstruction insn) {
  ...
  int getThis (ThreadInfo ti, Instruction insn) {
    ...
    if (insn instanceof JVMReturnInstruction) {
      return ((JVMReturnInstruction)insn).getReturnFrame().getThis();
    } else {
  ...
  void processReturnInstruction (ThreadInfo ti, JVMReturnInstruction insn) {
    MethodInfo mi = insn.getMethodInfo();
